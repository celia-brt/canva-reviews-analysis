...
> Dataset included — `data/canva_reviews_clean.csv` 
...
84.7% of users are satisfied. But 5,143 users left negative 
reviews with an average score of 1.24 — not mild dissatisfaction, 
genuine frustration. Among these, 1,223 contain explicit complaint 
keywords — the most actionable signal.
...
Version 2.335.1 peaks at 18.9% negative rate — a likely bad release. 
Recent versions stabilise around 7-10%, suggesting incremental 
improvement but no full resolution.

**Q4 — Is Canva actually listening?**
Canva responds to 96.9% of negative reviews — impressive at first 
glance. But 99.7% of those responses are identical automated 
messages. Only 43 out of 13,087 responses are personalised. 
High response rate ≠ high quality of care.

---

## 📊 Dashboard

👉 [View Looker Studio Dashboard](#) ← link coming soon
